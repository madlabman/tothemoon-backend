...
<div class="uk-container uk-padding">
    ...
    <table class="uk-table uk-table-middle">
        ...
        <tr>
            <form action="{{ url()->to('/users/quick-update') }}" method="post">
                ...
                <td>
                    <input type="number" value="{{ $user->balance->body }}" name="body" class="uk-input" step="any">
                </td>
                <td>
                    <input type="number" value="{{ $user->balance->bonus }}" name="bonus" class="uk-input" step="any">
                </td>
                <td>
    ...
    <ul class="uk-pagination uk-flex-center uk-padding">
        ...
        <li class="@if($page['active']){{ 'uk-active' }}@endif"><a href="{{ $page['link'] }}">{{ $page['text'] }}</a>
        </li>
        @endforeach
    </ul>
    @endif
